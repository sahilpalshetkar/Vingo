...
const Checkout = () => {
  ...
  const getLatLngByAddress = async () => {
    try {
      ...
      // dispatch(setAddressInput(result.data));
      ...
      <div className="w-full max-w-225 bg-white rounded-2xl shadow-xl p-6 space-y-6">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <span className="inline-flex w-10 h-10 items-center justify-center rounded-full bg-purple-100">
                <FaMobileScreenButton className="text-purple-700 text-lg" />
              </span>
              <span className="inline-flex w-10 h-10 items-center justify-center rounded-full bg-blue-100">
